...
To verify a release artifact manually, download the artifact (e.g. `mex_admin-<tag>-py3-none-any.whl`) and its Sigstore bundle (`mex_admin-<tag>-py3-none-any.whl.sigstore.json`), then run either:

**Using `sigstore`**:
```bash
sigstore verify identity \
  --bundle <path-to-bundle> \
  --cert-identity "https://github.com/robert-koch-institut/mex-admin/.github/workflows/release.yml@refs/heads/main" \
...
cosign verify-blob \
  --bundle <path-to-bundle> \
  --certificate-identity "https://github.com/robert-koch-institut/mex-admin/.github/workflows/release.yml@refs/heads/main" \
